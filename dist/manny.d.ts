import { Object3D, AnimationAction, AnimationMixer } from 'three';
...
declare function Manny(): MannyReturn;
declare function Manny(args: BaseProps): MannyReturn;
declare function Manny(args: DefaultAnimationProps): MannyReturn;
declare function Manny<T extends AnimationLibrary>(props: Props<T>): MannyReturn;
